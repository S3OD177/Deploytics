...
export const integrationDefinitions: IntegrationDefinition[] = [
    ...
    { id: 'azure', name: 'Azure', category: 'Cloud', description: 'Integration with Azure DevOps and Cloud.', icon: 'Azure', status: 'coming_soon', color: "text-[#0078D4]", bgColor: "bg-[#1e1e1e]" },
    { id: 'gcp', name: 'Google Cloud', category: 'Cloud', description: 'GCP deployment tracking.', icon: 'GoogleCloud', status: 'coming_soon', color: "text-[#4285F4]", bgColor: "bg-white" },
    { id: 'digitalocean', name: 'DigitalOcean', category: 'Cloud', description: 'App Platform and Droplet monitoring.', icon: 'DigitalOcean', status: 'coming_soon', color: "text-[#0080FF]", bgColor: "bg-white" },
    { id: 'heroku', name: 'Heroku', category: 'Cloud', description: 'Heroku Dyno and build tracking.', icon: 'Heroku', status: 'coming_soon', color: "text-[#430098]", bgColor: "bg-white" },
    { id: 'fly', name: 'Fly.io', category: 'Cloud', description: 'Global application platform.', icon: 'Fly', status: 'coming_soon', color: "text-[#24185B]", bgColor: "bg-white" },
    ...
    // --- CI/CD ---
    { id: 'circleci', name: 'CircleCI', category: 'CI/CD', description: 'Continuous integration and delivery.', icon: 'CircleCI', status: 'coming_soon', color: "text-white", bgColor: "bg-[#343434]" },
    ...
    { id: 'jenkins', name: 'Jenkins', category: 'CI/CD', description: 'Open source automation server.', icon: 'Jenkins', status: 'coming_soon', color: "text-[#D33833]", bgColor: "bg-white" },
    ...
    // --- Monitoring ---
    { id: 'datadog', name: 'Datadog', category: 'Monitoring', description: 'Cloud monitoring as a service.', icon: 'Datadog', status: 'coming_soon', color: "text-[#632CA6]", bgColor: "bg-white" },
    { id: 'newrelic', name: 'New Relic', category: 'Monitoring', description: 'Observability platform.', icon: 'NewRelic', status: 'coming_soon', color: "text-[#008C99]", bgColor: "bg-white" },
    { id: 'sentry', name: 'Sentry', category: 'Monitoring', description: 'Application monitoring and error tracking.', icon: 'Sentry', status: 'coming_soon', color: "text-[#362D59]", bgColor: "bg-white" },
    ...
    { id: 'grafana', name: 'Grafana', category: 'Monitoring', description: 'Operational dashboards.', icon: 'Grafana', status: 'coming_soon', color: "text-[#F46800]", bgColor: "bg-white" },
    ...
    { id: 'discord', name: 'Discord', category: 'Communication', description: 'Chat for communities.', icon: 'Discord', status: 'available', color: "text-white", bgColor: "bg-[#5865F2]" },
    { id: 'msteams', name: 'Microsoft Teams', category: 'Communication', description: 'Workspace for real-time collaboration.', icon: 'msteams', status: 'coming_soon', color: "text-[#6264A7]", bgColor: "bg-white" },
    ...
    { id: 'twilio', name: 'Twilio', category: 'Communication', description: 'SMS and voice notifications.', icon: 'Twilio', status: 'coming_soon', color: "text-[#F22F46]", bgColor: "bg-white" },

    // --- Project Management ---
    { id: 'jira', name: 'Jira', category: 'Project Management', description: 'Issue and project tracking.', icon: 'Jira', status: 'coming_soon', color: "text-[#0052CC]", bgColor: "bg-white" },
    { id: 'linear', name: 'Linear', category: 'Project Management', description: 'Issue tracking built for speed.', icon: 'Linear', status: 'coming_soon', color: "text-white", bgColor: "bg-[#5E6AD2]" },
    { id: 'asana', name: 'Asana', category: 'Project Management', description: 'Work management platform.', icon: 'Asana', status: 'coming_soon', color: "text-[#F06A6A]", bgColor: "bg-white" },
    ...
    { id: 'notion', name: 'Notion', category: 'Project Management', description: 'All-in-one workspace.', icon: 'Notion', status: 'coming_soon', color: "text-black dark:text-white", bgColor: "bg-white dark:bg-black" },
    ...
    { id: 'clickup', name: 'ClickUp', category: 'Project Management', description: 'One app to replace them all.', icon: 'ClickUp', status: 'coming_soon', color: "text-[#7B68EE]", bgColor: "bg-white" },
    ...
    // --- Analytics ---
    { id: 'mixpanel', name: 'Mixpanel', category: 'Analytics', description: 'Product analytics.', icon: 'Mixpanel', status: 'coming_soon', color: "text-[#7856FF]", bgColor: "bg-[#1E1E1E]" },
    ...
    // --- Security ---
    { id: 'snyk', name: 'Snyk', category: 'Security', description: 'Developer security platform.', icon: 'Snyk', status: 'coming_soon', color: "text-[#4C4A73]", bgColor: "bg-white" },
    { id: 'auth0', name: 'Auth0', category: 'Security', description: 'Authentication and authorization.', icon: 'Auth0', status: 'coming_soon', color: "text-[#EB5424]", bgColor: "bg-white" },
